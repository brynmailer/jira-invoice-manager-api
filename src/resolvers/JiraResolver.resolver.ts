import { Resolver, Authorized, UseMiddleware, Query, Mutation, Args, Ctx } from "type-graphql";
import { Repository } from "typeorm";
import { InjectRepository } from "typeorm-typedi-extensions";
import { Inject } from "typedi";
import * as bcrypt from "bcrypt";

import { User, Message, JiraResource, JiraProject, JiraIssue, JiraWorklog } from "../entities";
import { GetProjectsArgs, GetIssuesArgs, GetWorklogsArgs, ExchangeAuthCodeArgs } from "./types";
...
export class JiraResolver {
  ...
  async getProjects(
    ...
    return ctx.dataSources.jiraAPI.getProjects(
      cloudId,
      page,
      pageSize
    );
